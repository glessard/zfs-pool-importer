...
/bin/cp "${BUILD}/${NAME}" "/usr/local/zfs/libexec/zfs/launchd.d/${NAME}"
...
/bin/echo "Please enable full disk access for \"zfs-pool-importer\" in the \"Security & Privacy\" pane of System Preferences."
